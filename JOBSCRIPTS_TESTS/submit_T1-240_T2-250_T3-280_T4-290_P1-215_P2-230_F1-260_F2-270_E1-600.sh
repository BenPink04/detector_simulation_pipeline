...
# Master job submission script for configuration: T1-240_T2-250_T3-280_T4-290_P1-215_P2-230_F1-260_F2-270_E1-600

set -e

echo "=== Submitting jobs for detector configuration: T1-240_T2-250_T3-280_T4-290_P1-215_P2-230_F1-260_F2-270_E1-600 ==="
...
for run in $(seq 1 100); do
    if [ -z "$PREV_BUILD_ID" ]; then
        ...
        BUILD_ID=$(sbatch /users/bp969/scratch/JOBSCRIPTS_TESTS/temp_jobs/build_${run}_T1-240_T2-250_T3-280_T4-290_P1-215_P2-230_F1-260_F2-270_E1-600.job | awk '{print $4}')
        echo "Submitted build $run: Job ID $BUILD_ID (no dependency)"
    else
        # Subsequent builds depend on previous build completion
        BUILD_ID=$(sbatch --dependency=afterok:$PREV_BUILD_ID /users/bp969/scratch/JOBSCRIPTS_TESTS/temp_jobs/build_${run}_T1-240_T2-250_T3-280_T4-290_P1-215_P2-230_F1-260_F2-270_E1-600.job | awk '{print $4}')
    ...
    RUN_ID=$(sbatch --dependency=afterok:$BUILD_ID /users/bp969/scratch/JOBSCRIPTS_TESTS/temp_jobs/run_${run}_T1-240_T2-250_T3-280_T4-290_P1-215_P2-230_F1-260_F2-270_E1-600.job | awk '{print $4}')
...
for group in $(seq 1 10); do
    JOB_ID=$(sbatch --dependency=afterok:$RUN_DEPENDENCY /users/bp969/scratch/JOBSCRIPTS_TESTS/temp_jobs/parse_group_${group}_T1-240_T2-250_T3-280_T4-290_P1-215_P2-230_F1-260_F2-270_E1-600.job | awk '{print $4}')
...
COMBINE_JOB_ID=$(sbatch --dependency=afterok:$PARSE_DEPENDENCY /users/bp969/scratch/JOBSCRIPTS_TESTS/temp_jobs/combine_T1-240_T2-250_T3-280_T4-290_P1-215_P2-230_F1-260_F2-270_E1-600.job | awk '{print $4}')
...
echo "Results will be in: /users/bp969/scratch/VIKING_FOLDER/SIMULATION_RESULTS/T1-240_T2-250_T3-280_T4-290_P1-215_P2-230_F1-260_F2-270_E1-600"
