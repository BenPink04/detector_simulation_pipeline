...
void KLong_plot_resolution_comparison_test() {
    ...
    std::vector<std::tuple<std::string, std::string, int>> configurations = {
        {"/users/bp969/scratch/VIKING_FOLDER/DATA_PARSING/SCEN5_DATA_READ/out_seed_Scen5_3_vectors.root", 
         "Config 1: T1=250, T2=260, T3=330, T4=340", kBlue},
        {"/users/bp969/scratch/VIKING_FOLDER/DATA_PARSING/SCEN5_DATA_READ/out_seed_Scen5_2_vectors.root", 
         "Config 2: T1=300, T2=310, T3=380, T4=390", kRed},
        {"/users/bp969/scratch/VIKING_FOLDER/DATA_PARSING/SCEN5_DATA_READ/out_seed_Scen5_1_vectors.root", 
         "Config 3: T1=350, T2=360, T3=430, T4=440", kGreen+2} 
