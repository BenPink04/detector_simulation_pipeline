...
void KLong_plot_acceptance() {
    std::vector<std::string> filenames = {
        "out_seed_Scen5_1_acceptance.root",
        "out_seed_Scen5_2_acceptance.root",
        "out_seed_Scen5_3_acceptance.root",
        "out_seed_Scen5_4_acceptance.root",
        "out_seed_Scen5_5_acceptance.root",
        "out_seed_Scen5_6_acceptance.root",
        "out_seed_Scen5_7_acceptance.root",
        "out_seed_Scen5_8_acceptance.root",
        "out_seed_Scen5_9_acceptance.root",
        "out_seed_Scen5_10_acceptance.root"
