...
void KLong_plot_resolution_histbar() {
    std::vector<std::string> filenames = {
        "out_seed_Scen5_1_vectors.root",
        "out_seed_Scen5_2_vectors.root",
        "out_seed_Scen5_3_vectors.root",
        "out_seed_Scen5_4_vectors.root",
        "out_seed_Scen5_5_vectors.root",
        "out_seed_Scen5_6_vectors.root",
        "out_seed_Scen5_7_vectors.root",
        "out_seed_Scen5_8_vectors.root",
        "out_seed_Scen5_9_vectors.root",
        "out_seed_Scen5_10_vectors.root"
    };
