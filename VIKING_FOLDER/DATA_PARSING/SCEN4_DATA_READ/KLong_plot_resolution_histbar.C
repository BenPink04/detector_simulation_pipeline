...
void KLong_plot_resolution_histbar() {
    std::vector<std::string> filenames = {
        "out_seed_Scen4_1_vectors.root",
        "out_seed_Scen4_2_vectors.root",
        "out_seed_Scen4_3_vectors.root",
        "out_seed_Scen4_4_vectors.root",
        "out_seed_Scen4_5_vectors.root",
        "out_seed_Scen4_6_vectors.root",
        "out_seed_Scen4_7_vectors.root",
        "out_seed_Scen4_8_vectors.root",
        "out_seed_Scen4_9_vectors.root",
        "out_seed_Scen4_10_vectors.root"
    };
    ...
    gPad->SaveAs("KLong_resolution_plot.png");

    std::cout << "Plot saved as KLong_resolution_plot.png" << std::endl;
