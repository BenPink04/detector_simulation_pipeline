...
void KLong_plot_acceptance() {
    std::vector<std::string> filenames = {
        "out_seed_Scen4_1_acceptance.root",
        "out_seed_Scen4_2_acceptance.root",
        "out_seed_Scen4_3_acceptance.root",
        "out_seed_Scen4_4_acceptance.root",
        "out_seed_Scen4_5_acceptance.root",
        "out_seed_Scen4_6_acceptance.root",
        "out_seed_Scen4_7_acceptance.root",
        "out_seed_Scen4_8_acceptance.root",
        "out_seed_Scen4_9_acceptance.root",
        "out_seed_Scen4_10_acceptance.root"
