...
G4VPhysicalVolume* JLabKDetectorConstruction::Construct()
{
  ...
  //G4double trkrPosZ[4] = {50.*cm, 60.*cm, 130.*cm, 140.*cm};
  G4double trkrPosZ[4] = {50.*cm, 60.*cm, 130.*cm, 140.*cm};
  ...
  //G4double pizzaPosZ[4] = {15.*cm, 30.*cm, 1100.*cm, 1200.*cm};
  G4double pizzaPosZ[4] = {15.*cm, 30.*cm, 1100.*cm, 1200.*cm};
  ...
  G4double friPosZ[2] = {90.*cm, 100.*cm};  //replaces downstream pizzas from conceptual design - Position of FRI 
  //G4double friPosZ[2] = {90.*cm, 100.*cm};  //replaces downstream pizzas from conceptual design
  ...
  G4double tofPosZ = 200.*cm;  //replace downstream pizzas
